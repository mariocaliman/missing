...
$sql = "INSERT INTO categories (category,index_view,menu_view,seo_keywords,seo_description,category_order) VALUES ('$category','$index_view','$menu_view','$seo_keywords','$seo_description','0')";
...
<div class="page-header page-heading">
	...
	<a href="seed_states.php" class="btn btn-info pull-right" style="margin-right:10px;"><span class="fa fa-database"></span> Seed US States</a>
