...
} elseif (check_source_url($rss_link) > 0) {
$message = notification('warning','This Source is Added Before.');
...
$sql = "INSERT INTO sources (title,rss_link,category_id,thumbnail,news_number,latest_activity,auto_update) VALUES ('$title','$rss_link','$category_id','$thumbnail','$news_number','0','$auto_update')";
...
?>
		...
		<form role="form" method="POST" action="" enctype="multipart/form-data">
		  ...
		  <div class="form-group">
			...
			<option value="0">All Available In Feed</option>
			<?php 
			for($i=1;$i<31;$i++) {
			?>
...
?>
		...
		<form role="form" method="POST" action="" enctype="multipart/form-data">
		  ...
		  <div class="form-group">
			<label for="news_number">News Number Per Grab <span>*</span></label>
			<select class="form-control" name="news_number" id="news_number">
			<option value="0" <?php if ($source['news_number'] == 0) {echo 'SELECTED';} ?>>All Available In Feed</option>
			<?php 
			for($i=1;$i<31;$i++) {
			?>
...
?>
		<tr>
			...
			<td><a href="<?php echo $row['rss_link']; ?>" target="_BLANK" rel="noopener"><?php echo $row['rss_link']; ?></a></td>
			<td class="hidden-xs"><?php echo get_category($row['category_id']); ?></td>
			<td><?php echo get_source_news($row['id']); ?></td>
