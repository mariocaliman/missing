...
<div class="page-header page-heading">
		...
		<form role="form" method="POST" action="">
		  <div class="form-group">
			...
			<?php for ($n=1;$n<11;$n++) { ?>
			<option value="<?php echo $n; ?>" <?php if ($options['home_category_news_number'] == $n) {echo 'SELECTED';} ?>><?php echo $n; ?></option>
			<?php } ?>
			</select>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
			...
			<input type="number" name="source_news_number" id="source_news_number" class="form-control" value="<?php echo $options['source_news_number']; ?>" placeholder="12" />
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
			...
			<?php for ($t=1;$t<11;$t++) { ?>
			<option value="<?php echo $t; ?>" <?php if ($options['top_news_number'] == $t) {echo 'SELECTED';} ?>><?php echo $t; ?></option>
			<?php } ?>
			</select>
		  </div>
		  <div class="form-group">
			<input type="checkbox" name="allow_lazyload" id="allow_lazyload" value="1" <?php if (isset($options['allow_lazyload']) AND $options['allow_lazyload'] == 1) {echo 'CHECKED';} ?> /> <span class="checkbox-label">Allow Image Loading using LazyLoad ?</span>
		  </div>
